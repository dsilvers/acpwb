...
EXPORTS = [
    ...
    (policy_data, [
        ...
        ('_REGIONS', 'REGIONS'),
        ('_STAKEHOLDER_TYPES', 'STAKEHOLDER_TYPES'),
        ('_RISK_LEVELS', 'RISK_LEVELS'),
        ('_FOOTNOTE_PUBLISHERS', 'FOOTNOTE_PUBLISHERS'),
        ('EXECUTIVE_SUMMARY_TEMPLATES', 'EXECUTIVE_SUMMARY_TEMPLATES'),
        ('EXHIBIT_INTRO_TEMPLATES', 'EXHIBIT_INTRO_TEMPLATES'),
    ]),
    (people_generators, [
