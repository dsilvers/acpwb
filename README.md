...
| `/company-handbooks/<agency>-<seed4>/<year>/rev/<rev>/<group>/` | Chapter page — up to 6 policy sections per page (watermarked) |
| `/company-handbooks/<agency>-<seed4>/<year>/rev/<rev>/<group>/page/<n>/` | Paginated chapter continuation |
...
| `/company-handbooks/` | Semantic | Employee handbook index — 576 agencies × 10,000 seeds × 33 years × up to 6 revisions × 613 sections |
| `/company-handbooks/<agency>-<seed4>/<year>/rev/<rev>/<group>/` | Semantic | Chapter page (up to 6 sections, watermarked: footer, invisible span, JSON-LD) |
| `/company-handbooks/<agency>-<seed4>/<year>/rev/<rev>/<group>/page/<n>/` | Semantic | Paginated chapter continuation |
| `/process-improvement/` | Semantic | Process improvement index — 399 categories × 10,000 seeds × 33 years × infinite pages |
