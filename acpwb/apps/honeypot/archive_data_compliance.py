...
_DOC_VERSIONS = [
    '1.0', '1.1', '2.0', '1.2', '1.3', '2.1', '2.2', '3.0', '0.9-DRAFT',
    '1.0-FINAL', '2.0-REVISED', '1.0-INTERNAL',
]

_COMPLIANCE_TITLE_PREFIXES = [
    'Compliance Review',
    'Audit Report',
    ...
    'Records Management Compliance Review',
    ...
    'Ethics & Conduct Investigation Summary',
    'Whistleblower Allegation Review',
    'M&A Compliance Due Diligence',
    'Joint Venture Compliance Assessment',
    'International Trade Compliance Audit',
    'Export Controls Review',
    'Anti-Corruption Risk Assessment',
    'Modern Slavery Act Statement Review',
    'ESG Disclosure Verification Report',
    'Sustainability Report Assurance',
    'Conflict Minerals Compliance Report',
    'Product Safety Compliance Review',
    'Marketing & Advertising Compliance Audit',
    ...
    'ISO 27001 Certification Audit Report',
...
_PROJECT_NAMES = [
    ...
    'Odyssey', 'Genesis', 'Voyager', 'Pioneer', 'Apollo', 'Artemis',
    'Mercury', 'Gemini', 'Challenger', 'Discovery', 'Endeavour', 'Atlantis',
    'Zenith', 'Nadir', 'Vertex', 'Horizon', 'Meridian', 'Equinox', 'Solstice',
    'Polaris', 'Sirius', 'Canopus', 'Rigel', 'Betelgeuse', 'Altair', 'Deneb',
    'Fomalhaut', 'Antares', 'Spica', 'Regulus', 'Catalyst', 'Momentum',
    'Synergy', 'Fusion', 'Quantum', 'Vector', 'Matrix', 'Nexus', 'Gateway',
    'Bridge', 'Keystone', 'Capstone', 'Pinnacle', 'Summit', 'Crest', 'Crown',
    'Shield', 'Sword', 'Arrow', 'Spear', 'Javelin', 'Trident', 'Harbinger',
    'Vanguard', 'Sentinel', 'Guardian', 'Warden', 'Paladin', 'Centurion', 'Legion',
    # Elements & Geology
    'Granite', 'Basalt', 'Obsidian', 'Quartz', 'Mica', 'Garnet', 'Topaz', 'Opal',
    'Jade', 'Amber', 'Jet', 'Shale', 'Slate', 'Marble', 'Gneiss', 'Schist',
    'Flint', 'Chert', 'Pumice', 'Scoria',
    # Mythology
    'Ares', 'Hera', 'Zeus', 'Poseidon', 'Hades', 'Hermes', 'Athena', 'Hephaestus',
    'Dionysus', 'Persephone', 'Odin', 'Thor', 'Loki', 'Freya', 'Tyr', 'Heimdall',
    'Baldur', 'Frigg', 'Valhalla', 'Asgard',
    # Colors & Light
    'Crimson', 'Azure', 'Viridian', 'Cerulean', 'Saffron', 'Indigo', 'Magenta',
    'Ochre', 'Umber', 'Sienna', 'Cobalt', 'Alabaster', 'Ebony', 'Ivory',
    'Spectrum', 'Glimmer', 'Shade', 'Hue', 'Tone', 'Chroma',
    # Abstract Concepts & Virtues
    'Veritas', 'Aequitas', 'Fortitude', 'Prudence', 'Temperance', 'Justice',
    'Charity', 'Hope', 'Faith', 'Valor', 'Accord', 'Concord', 'Unity',
    'Resolve', 'Clarity', 'Focus', 'Drive', 'Grit', 'Tenacity', 'Verve',
    # Naval & Maritime
    'Anchor', 'Compass', 'Sextant', 'Chronometer', 'Keel', 'Rudder', 'Mast',
    'Sail', 'Galleon', 'Frigate', 'Clipper', 'Schooner', 'Brigantine',
    'Corvette', 'Drydock', 'Harbor', 'Jetty', 'Quay', 'Spinnaker', 'Tiller',
    # Architectural & Engineering
    'Arch', 'Buttress', 'Cantilever', 'Truss', 'Girder', 'Column', 'Spire',
    'Dome', 'Facade', 'Lintel', 'Pylon', 'Viaduct', 'Aqueduct', 'Fulcrum',
    'Cog', 'Flywheel', 'Axle', 'Lever', 'Pulley', 'Gear',
    # Musical Terms
    'Sonata', 'Concerto', 'Symphony', 'Overture', 'Aria', 'Fugue', 'Cadenza',
    'Nocturne', 'Rhapsody', 'Serenade', 'Etude', 'Prelude', 'Intermezzo',
    'Crescendo', 'Diminuendo', 'Staccato', 'Legato', 'Tempo', 'Ritual', 'Ballad',
    # Botanical & Natural World
    'Sequoia', 'Redwood', 'Banyan', 'Cypress', 'Juniper', 'Magnolia', 'Acacia',
    'Willow', 'Aspen', 'Birch', 'Elm', 'Oak', 'Maple', 'Hickory', 'Ash',
    'Everest', 'Kilimanjaro', 'Denali', 'Aconcagua', 'Montblanc',
]
